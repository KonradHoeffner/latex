...
\item June 26 	Science Seminar with Fabian Winkler's first Diploma presentation, supervised by Mr. Kirsten. \emph{Semiautomatische Metadatenerzeugung für Studiendaten auf Basis des LIFE-Metadatenkatalog}
\end{itemize}
\end{posterbox}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

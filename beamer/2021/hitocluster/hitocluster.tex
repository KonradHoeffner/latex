...
\begin{itemize}
\item viel Wissen über SWPs gesammelt, aber wie hängen diese zusammen?
\item LodView vergleicht nicht Details, SNIK Graph unübersichtlich
\item Anwendungsystemtypen (ASTs) bieten manuelle Gruppierung aber nur für 10/51 SWPs verfügbar, 5 davon $> 1$ AST

...
%   \arcarrow{ 85}{  3}{ Transformation}
   ...
   \arcarrow{-210}{-260}{~~~Model}{mypink}
   %\arcarrow{-230}{-270}{~~~Interlink}{mygray}

   \arcarrow{-270}{-300}{~~~Browse}{mygray}
   \arcarrow{-310}{-390}{~~~Search/Explore}{mygray}
...
%   \arcarrow{ 85}{  3}{ TARQL }
   ...
   \barcarrow{-210}{-260}{~~~~~~Instance Generator~~}{mypink}
   %\barcarrow{-230}{-270}{LIMES}{mygray}

   \barcarrow{-270}{-300}{~~~~LodView}{mygray}
   \barcarrow{-310}{-390}{~~Faceted Search, SNIK Graph}{mygray}

...
\begin{frame}[plain]{~~~~#2}
\centering\includegraphics[width=1.01\textwidth,height=0.95\textheight,keepaspectratio]{#3}
\\#1
\note{#4}
\end{frame}
\restoregeometry
...
\begin{frame}{Search \& Exploration: SNIK Graph}
\end{frame}



\begin{frame}{Applications: Reused and Self-Developed}
spiderworm
snik bingo
snik graph
ontowiki
lifecycle git tickets
\end{frame}

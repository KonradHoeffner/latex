...
Abgeschlossenes DFG-Projekt. Projektziele: 
\begin{enumerate}
 \item modulare Ontologie des \textit{Informationsmanagements im Krankenhaus}: 
 \begin{itemize}
  \item Metamodell
  \item \enquote{Unterontologien} für jedes Lehrbuch
 \end{itemize}
...
\begin{itemize}
\item Visualisierung anderer Ontologien
\item Basis für Systemanalyse
\item Ontologie-unterstütztes Schreiben von Lehrbüchern
\item Bearbeitung in SNIK Graph

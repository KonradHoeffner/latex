...
Projekt ist abgeschlossen, Projektziele waren:
\begin{enumerate}
 \item Eine modulare Ontologie des \textit{Informations-Managements im Krankenhaus} erstellen:
 \begin{itemize}
  \item ein Grund-Vokabular entwickeln (Metamodell)
  \item Lehrbücher in strukturiertes Wissen transformieren 
 \end{itemize}
 \item Daten kontinuierlich weiterentwickeln 
...
\item Standardformat $\rightarrow$ Verwenden von existierenden Anwendungen
\item Eigenentwicklungen nur wenn Bedarf nicht abgedeckt, Visualisierung
...
\item Visualisierung von anderen Ontologien
\item Formale Untermauerung der Ontologie (\textit{General Formal Ontology})

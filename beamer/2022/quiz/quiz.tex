...
\begin{frame}{Distractor Generation}
\begin{itemize}
\item Must be wrong answers 
\item Should be plausible
\item Use graph structure of the data: first and second order neighbours of the key resource
\end{itemize}
\end{frame}
...
%\item didactic value of close match questions unclear
